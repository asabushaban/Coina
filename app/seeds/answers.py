...
def seed_answers():
    ...
    db.session.add(Answer(body="It's hard to say, but Vitalik is estimating thousands per second with layer two help", user_id=1, question_id=6, created_at=today, updated_at=today))
    db.session.add(Answer(body="It doesn't matter if gas fees are stay so high!", user_id=2, question_id=6, created_at=today, updated_at=today))
    ...
    db.session.add(Answer(body="Ethereum will scale.. patience is key!", user_id=15, question_id=9, created_at=today, updated_at=today))
    ...
    db.session.add(Answer(body="you can never have enough", user_id=12, question_id=10, created_at=today, updated_at=today))
    ...
    db.session.add(Answer(body="it's basically decentralizing the interent", user_id=3, question_id=12, created_at=today, updated_at=today))
    db.session.add(Answer(body="the fourth industrial revolution", user_id=6, question_id=12, created_at=today, updated_at=today))
    db.session.add(Answer(body="Coinbase has FDIC insurance!", user_id=7, question_id=13, created_at=today, updated_at=today))
